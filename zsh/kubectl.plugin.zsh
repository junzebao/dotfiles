# Standalone alias/function section from the Oh My Zsh kubectl plugin.
# Completion setup is already handled by zshrc.
# Source: https://github.com/ohmyzsh/ohmyzsh/tree/master/plugins/kubectl
